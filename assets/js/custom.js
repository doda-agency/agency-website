...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function renderProjects(projects, container, type) {
    ...
    projects.forEach(project => {
      ...
      const imageUrl = project.image || '../assets/img/projects/placeholder.jpg';
  ...
  if (document.getElementById('featured-projects')) {
    loadProjects('../data/portfolio-projects.json', 'featured-projects', 'featured');
  }
  
  if (document.getElementById('current-projects')) {
    loadProjects('../data/current-projects.json', 'current-projects', 'current');
  }
